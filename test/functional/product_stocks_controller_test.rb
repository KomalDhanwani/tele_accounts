...
class ProductStocksControllerTest < ActionController::TestCase
  ...
  test "should create product_stock" do
    assert_difference('ProductStock.count') do
      post :create, product_stock: { price_per_quantity: @product_stock.price_per_quantity, product_id: @product_stock.product_id, purchased_from: @product_stock.purchased_from, quantity: @product_stock.quantity, total_amount: @product_stock.total_amount }
    end
  ...
  test "should update product_stock" do
    put :update, id: @product_stock, product_stock: { price_per_quantity: @product_stock.price_per_quantity, product_id: @product_stock.product_id, purchased_from: @product_stock.purchased_from, quantity: @product_stock.quantity, total_amount: @product_stock.total_amount }
    assert_redirected_to product_stock_path(assigns(:product_stock))
  end
